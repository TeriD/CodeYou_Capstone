...
3. **Visualization:**
        <p>Overall, there were 13 visualizations produced for this project.  Each of the visualizations allowed for the learning of new python modules and techniques that I had not utilized previously.  One of the most important aspects of a visualization is to determine if the selected visualization represents the data in the best way possible - in other words, can the audience see what the data actually represents!</p>
...
- **Deaths and Speed Visualizations:**
    ...
    <p>By combining the ksp_incidents data via a join to the ksp_person table, the following query separates the fatalities and injuries into groups by person type as represented by the graph on the right below.
...
- **Incident Locations Map:**
  - Interactive map displaying incident locations using Folium and Panel.
-
  - <div style="left_margin: 100px 0; position: relative"><p>Folium Map</p>
            <img src="Report_Images/Folium_IncidentsMap.png" alt="Folium Incidents Map" width="800">
    </div>
- **Human Factor Visualizations:**
  - Word cloud, bar graph, and pie chart of factors influencing incidents.
...
JOIN unit_factor_code_lut t2
  ...
  - <div style="display: flex; justify-content: space-between; width: 100%;">
    ...
    <div style="left_margin: 100px 0; position: relative"><p>Human Factors</p>
            <img src="Report_Images/HumanFactors_PieChart.png" alt="Human Factors Pie Chart" width="600">
    </div>
- **Incidents by District and Year:**
  - Dash app displaying incidents by district and year.
-
- SELECT t1.IncidentID, t2.KYTC_District_Number AS District, t2.D_District,
    ...
    <div style="display: flex; justify-content: space-between; width: 100%;">
        <img src="Report_Images/IncidentCountByDistrict_Initial.png" alt="District and Year" style="width: 48%;">
        <img src="Report_Images/IncidentCountByDistrict_withDropdownSelector.png" alt="District Year Dropdown" style="width: 48%;">
    </div>
- **Traffic Controls Visualizations:**
  - Stacked bar chart of traffic control devices by route type and district.
- SELECT
    rc.Route_Type,
    c.TrafficControl,
...
- **Vehicle Type Visualization:**
  - Pie chart of vehicle types involved in incidents using Bokeh.
...
## Conclusion
The project successfully analyzed and visualized traffic accidents in construction work zones in Kentucky. Key trends and factors were identified, providing insights for improving roadway safety. The use of multiple visualization techniques and the integration of various datasets enhanced the comprehensiveness of the analysis.
...
- Expand the project to include additional years of data.
- Develop a cohesive Panel application integrating all visualizations.
- Enhance data visualizations and interactivity.
- Investigate further data queries for deeper analysis.
